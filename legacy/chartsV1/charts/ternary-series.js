import TernaryAxis from "../module/TernaryAxis";
    ...
    {},
    {
      ...
      beforeTranslate() {
        ...
        for (i = 0; i < dataLength; i++) {
          ...
          // fixed: 0
          point.plotX = plotX =
            ternaryArgs.points[0][0] + point.x * ternaryArgs.width - plotLeft;
          ...
          // fixed: 1
          point.plotY =
            ternaryArgs.points[1][1] - point.y * ternaryArgs.height - plotTop;
