...
class Legend {
  ...
  render() {
    ...
    this.group.element._index = this.options._index;
    ...
    switch (this.options.align) {
      case "left":
        ...
        break;
      case "center":
        x = this.chart.plotLeft + this.chart.plotWidth / 2 - bbox.width / 2;
        break;
      case "right":
        x =
          this.chart.plotLeft +
    ...
    switch (this.options.verticalAlign) {
      case "middle":
        y = this.chart.plotTop + this.chart.plotHeight / 2 - bbox.height / 2;
  ...
  renderItem(item, index, position) {
    ...
    if (this.options.layout === "horizontal") {
      ...
      y = position.y; //+ this.options.itemMarginTop;
    } else {
