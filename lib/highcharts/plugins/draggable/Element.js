...
export default class Element {
  ...
  constructor(elemet, chart) {
    ...
    this.containerSize = [
      this.chart.spacingBox.width + this.chart.spacingBox.x,
      this.chart.spacingBox.height + this.chart.spacingBox.y,
    ...
    // this.chart.renderer
    //   .rect(0, 0, this.containerSize[0], this.containerSize[1])
    //   .attr({
    //     stroke: "red",
    //     "stroke-width": 1,
    //   })
